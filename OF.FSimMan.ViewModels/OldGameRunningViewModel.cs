...
{
    public class OlddGameRunningViewModel : ViewModelBase
    {
        #region Properties
        ...
        #region Constructor
        public OlddGameRunningViewModel(GameViewModelBase gameViewModel) : base("Game Running")
        {
            _gameViewModel = gameViewModel;

            CloseGameCommand = new Command(this, target => ((OlddGameRunningViewModel)target).CloseGameDelegate());
