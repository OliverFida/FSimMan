...
{
    public abstract class EditableObjectBase : BindingObjectBase, IEditableObject
    {
        ...
        public bool IsModified
        {
            get
            {
                ...
                foreach (var item in _originalObjects)
                {
                    ...
                    if (((EditableObjectBase)prop!.GetValue(this)!).IsModified) return true;
                }
        ...
        public void BeginEdit()
        {
            ...
            foreach (var prop in GetType().GetProperties()
                .Where(p => typeof(EditableObjectBase).IsAssignableFrom(p.PropertyType) && p.PropertyType.IsGenericType == false && p.PropertyType != GetType()))
            {
                if (!prop.CanRead || !prop.CanWrite) continue;

                _originalObjects[prop.Name] = prop.GetValue(this)!;
                ((EditableObjectBase)prop.GetValue(this)!).BeginEdit();
            }
        ...
        public void CancelEdit()
        {
            ...
            foreach (var orgVal in _originalObjects)
            {
                ...
                prop.SetValue(this, orgVal.Value);
                ((EditableObjectBase)prop.GetValue(this)!).CancelEdit();
            }
            _originalObjects.Clear();
        ...
        public void EndEdit()
        {
            ...
            foreach (var orgVal in _originalObjects)
            {
                ...
                ((EditableObjectBase)prop.GetValue(this)!).EndEdit();
            }
            _originalObjects.Clear();
