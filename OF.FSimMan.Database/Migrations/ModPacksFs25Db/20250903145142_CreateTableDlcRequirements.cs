...
{
    /// <inheritdoc />
    public partial class CreateTableDlcRequirements : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "DlcRequirements",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DlcRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DlcRequirements_ModPacks_ModPackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DlcRequirements_ModPackId",
